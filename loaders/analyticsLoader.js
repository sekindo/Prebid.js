...
// In progress: a means to write loader code for libraries
function loadLibrary(adapter) {
  console.log('analytics loader loadLibrary');
  return `(function () {
            var doc = document;
            ...
            lib.src = 'http://localhost:9999/src/adapters/analytics/libraries/${adapter}.js';
            // lib.src = ${adapter}.url;
            target.insertBefore(lib, target.firstChild);
        })();`;
}
